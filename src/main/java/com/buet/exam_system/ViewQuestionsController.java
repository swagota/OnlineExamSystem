...
public class ViewQuestionsController implements Initializable {
    ...
    private void loadQuestions() {
        ...
        addBtn.setOnMouseExited(e -> addBtn.setStyle(
                "-fx-background-color: #1a2a4a;-fx-text-fill:white;-fx-font-size:14px;" +
                        "-fx-font-weight:bold;-fx-background-radius:10px;-fx-padding:10 30 10 30;-fx-cursor:hand;"));
        addBtn.setOnAction(e -> openAddQuestionPage(-1, null, null, -1));
    ...
    private VBox createQuestionCard(int serial, int qId,
        ...
        editBtn.setOnAction(e -> openAddQuestionPage(qId, questionText, options, correctAnswer));
    ...
    private void openAddQuestionPage(int qId, String questionText,
        ...
        try {
            ...
            controller.setTeacherInfo(teacherUsername, teacherEmail,
                    teacherFatherEmail, teacherMotherEmail);

            if (qId != -1) {
                controller.setEditMode(qId, questionText, options, correctAnswer);
            }
